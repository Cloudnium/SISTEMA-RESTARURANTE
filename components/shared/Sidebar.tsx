...
export default function Sidebar({ open, setOpen, active, setActive }: SidebarProps) {
  return (
    <>
      {/* Mobile overlay */}
      {open && (
      ...
      >
        ...
        >
          <div>
            ...
            <p
              className="text-2xl font-black tracking-widest mt-0.5"
        ...
        {/* ── User card ── */}
        <div
          className="mx-4 mt-4 mb-1 p-3 rounded-xl flex items-center gap-3 shrink-0"
        ...
        >
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold truncate" style={{ color: B.cream }}>Admin</p>
            <p className="text-xs" style={{ color: B.gold }}>Administrador</p>
          </div>
        </div>
                    ...
                    <button
                      ...
                      onMouseLeave={(e) => {
                        if (!isActive) {
                          ...
                          e.currentTarget.style.color = 'rgba(245,237,216,0.5)';
                        }
                      }}
                    >
                      {isActive && (
