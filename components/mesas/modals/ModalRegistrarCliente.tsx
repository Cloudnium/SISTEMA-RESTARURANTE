/* components/mesas/modals/ModalRegistrarCliente.tsx
'use client';
...
import type { Cliente, TipoComprobante, TipoCliente } from '@/lib/supabase/types';
...
export default function ModalRegistrarCliente({
  ...
  const handleGuardar = async () => {
    ...
    if (tipoComprobante === 'factura' && !form.documento.trim()) {
      setError('El RUC es obligatorio para factura');
      return;
    }
    setGuardando(true);
    setError('');
